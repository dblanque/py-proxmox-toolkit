...
parser.add_argument(
	...
	required=False,
	nargs=2,
	help="Returns Guest Status [GUEST_ID] [GUEST_TYPE]",
)
...
if not args.discovery and not args.status:
	parser.error(
		"No arguments entered, please enter a valid argument. (Use --h|--help for more information)"
	)
